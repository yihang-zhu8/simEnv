...
echo_and_run cd "/home/zhuyihang/simEnv/src/simenv_cbf_train"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/zhuyihang/simEnv/src/simenv_cbf_train/setup.py" \
     \
    build --build-base "/home/zhuyihang/simEnv/build/simenv_cbf_train" \
    install \
    --root="${DESTDIR-/}" \
