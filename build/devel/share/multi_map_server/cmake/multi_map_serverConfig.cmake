...
if("TRUE" STREQUAL "TRUE")
  set(multi_map_server_SOURCE_PREFIX /home/ros/Guoyulun/Competition/SimEnv/src/uav_simulator/Utils/multi_map_server)
  set(multi_map_server_DEVEL_PREFIX /home/ros/Guoyulun/Competition/SimEnv/build/devel)
...
if(NOT "/home/ros/Guoyulun/Competition/SimEnv/build/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multi_map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros/Guoyulun/Competition/SimEnv/src/uav_simulator/Utils/multi_map_server/${idir}'.  ${_report}")
    endif()
